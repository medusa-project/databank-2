class FunderCatalog
  ...
  ENTRIES = [
    Entry.new(code: "IDCEO", name: "Illinois Dept. of Commerce & Economic Opportunity (DCEO)", identifier: "10.13039/100004885", display_position: 10, identifier_scheme: "DOI"),
    Entry.new(code: "IDHS", name: "Illinois Dept. of Human Services (DHS)", identifier: "10.13039/100004886", display_position: 20, identifier_scheme: "DOI"),
    Entry.new(code: "IDNR", name: "Illinois Dept. of Natural Resources (IDNR)", identifier: "10.13039/100004887", display_position: 30, identifier_scheme: "DOI"),
    Entry.new(code: "IDOT", name: "Illinois Dept. of Transportation (IDOT)", identifier: "10.13039/100009637", display_position: 40, identifier_scheme: "DOI"),
    Entry.new(code: "USARMY", name: "U.S. Army", identifier: "10.13039/100006751", display_position: 50, identifier_scheme: "DOI"),
    Entry.new(code: "USDA", name: "U.S. Dept. of Agriculture (USDA)", identifier: "10.13039/100000199", display_position: 60, identifier_scheme: "DOI"),
    Entry.new(code: "DOE", name: "U.S. Dept. of Energy (DOE)", identifier: "10.13039/100000015", display_position: 70, identifier_scheme: "DOI"),
