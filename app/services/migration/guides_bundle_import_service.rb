...
module Migration
  class GuidesBundleImportService
    attr_reader :bundle_path, :dry_run, :checksum_path, :manifest_path, :replace_all

    VALID_TYPES = [ "Guide::Section", "Guide::Item", "Guide::Subitem" ].freeze

    def initialize(bundle_path:, dry_run: false, checksum_path: nil, manifest_path: nil, replace_all: true)
